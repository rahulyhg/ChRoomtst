...
public class IncognitoTab extends FragmentActivity
    ...
    boolean canSearch, toDraw;
    float maxZoom, nowZoom;
    private GoogleMap googleMap;
    private Marker pointMarker;
    double lat = 55.9811002, lng = 54.7508132;
    Context context;
...
//                ll = new LatLng(lat, lng);
    ...
    private void showDialogCheckIn(Context context){
        final String[] time_arr = {"5 минут", "30 минут", "60 минут"};
        ...
        builder.setItems(time_arr, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch(which){
                    case 0: time_checkin = "5";
                        break;
                    case 1: time_checkin = "30";
                        break;
                    case 2: time_checkin = "60";
                        break;
                }
...
//            ll = displayLocation();
//            longitude = new Double(ll.longitude).toString();
//            latitude = new Double(ll.latitude).toString();
            latitude = "55.9811511";
            longitude = "54.7508083";
        }
